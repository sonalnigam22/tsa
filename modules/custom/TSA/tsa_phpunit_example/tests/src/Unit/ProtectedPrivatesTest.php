...
namespace Drupal\Tests\tsa_phpunit_example\Unit;

use Drupal\Tests\UnitTestCase;

use Drupal\tsa_phpunit_example\ProtectedPrivates;

use Drupal\Tests\tsa_phpunit_example\Unit\Subclasses\ProtectedPrivatesSubclass;
...
class ProtectedPrivatesTest extends UnitTestCase {
  ...
  public function testPrivateAdd($expected, $a, $b) {
    ...
    $private_method = $this->getAccessibleMethod(
      'Drupal\tsa_phpunit_example\ProtectedPrivates',
      'privateAdd'
    );
